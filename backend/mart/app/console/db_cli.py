...
"""
    This function creates a new database using the provided database URL.
    It connects to the default database (postgres) and creates a new database
...
""" 
    This function deletes a database using the provided database URL.
    It connects to the default database (postgres) and drops the database
"""
